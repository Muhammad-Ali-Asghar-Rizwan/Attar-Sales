        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <p className="leading-relaxed text-3xl font-bold mb-4">
                Treasure of Fragrances!
              </p>
              <p>
                Explore our website for the finest attar from around the world,
                crafted to enrich your life with exquisite scents. Our collection
                features:
              </p>
              <br />
              ...
              <br />
              <p>
                Order your favorite attar online and we&apos;ll deliver it right
                to your doorstep.&quot;
              </p>
            </div>
          </div>
